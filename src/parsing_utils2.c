...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/05/16 16:14:24 by hetya             #+#    #+#             */
/*   Updated: 2022/05/16 16:36:08 by hetya            ###   ########lyon.fr   */
/*                                                                            */
/* ************************************************************************** */
...
int	preparsingutils(int *wsep, int *wtoken, char **word)
{
	...
	{
		ft_putstr_fd("Finishell: syntax error near '", 2);
		ft_putstr_fd(*word, 2);
		ft_putstr_fd("'\n", 2);
		g_return_value = 258;
		return (-1);
...
int	preparsing(char	*line, t_shell	*shell, t_cmddata	*result)
{
	...
	{
		ft_putstr_fd("Finishell: error end of line\n", 2);
		g_return_value = 258;
		return (-1);
	}
	return (0);
