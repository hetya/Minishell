...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/05/07 15:39:24 by hetya             #+#    #+#             */
/*   Updated: 2022/05/16 16:13:58 by hetya            ###   ########lyon.fr   */
/*                                                                            */
/* ************************************************************************** */
 ...
 */
t_cmddata	*ft_todata(char	**line, t_shell *shell)
{
	t_cmddata	*res;
	char		*word;
	...
	word = (res->infile--, res->outfile--, (char *) NULL);
	ft_getword(res, line, &word, shell);
	if (*word == '\0')
		return (NULL);
