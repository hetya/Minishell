...
/*   Updated: 2022/03/04 16:27:38 by hetya            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/**
 * count the word(separated by sep) in the string str
*/
...
/**
 * return the len of separator (if sep == / "///" : return 2) start at *s and
...
/**
 * check mallocs and free all the ptr if something goes wrong
*/
 ...
 * return a char ** containing all the string with a NULL terminator
*/
